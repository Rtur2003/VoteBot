...
"""
    ...
    def _build_ui(self):
        ...
        self.selectors_text.grid(row=22, column=1, sticky="ew", pady=(4, 0))
        selectors_helper = (
        ...
        ttk.Label(settings, text=selectors_helper, style="Helper.TLabel").grid(
            row=23, column=1, sticky="w", pady=(0, 8)
        )
        ...
        actions.grid(row=24, column=0, columnspan=2, sticky="ew", pady=(6, 0))
    ...
    def _set_form_state(self, running: bool):
        ...
        for check in [self.headless_check, self.auto_driver_check, self.random_ua_check]:
            if running:
